# Attention !
# this file is used only during make test on installation of bitflags
...
use bitflags {ic=>1}, qw( i_alfa i_beta i_gamma i_delta );
use bitflags qw( I_EPS I_FI I_DETHA I_PSI );
# use bitflags qw( i_eps i_fi i_detha i_psi );
use bitflags qw( i_rho );
